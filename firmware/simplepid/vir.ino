...
//
//// Control variables
//const float ANGLE_STEP = 0.65; // Angle change for A/D keys
...
//const unsigned long COMMAND_TIMEOUT = 100000; // Timeout period in milliseconds
//
...
//        switch (input) {
//            case 'F':
//                //last_command_time = micros();  // Update the last command time
...
//
//    if (abs(desired_tilt - initial_tilt) > 50.0) {
//        desired_tilt = initial_tilt;  
//    }
//    if (abs(desired_tilt - initial_tilt) < -50.0) {
//        desired_tilt = initial_tilt;  
