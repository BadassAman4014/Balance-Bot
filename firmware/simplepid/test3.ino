...
//
//// Control variables
//const float ANGLE_STEP = 0.80; // Angle change for F/B commands
...
//const unsigned long COMMAND_TIMEOUT = 20; // Timeout period in milliseconds
//
//// Define motor pins
...
//        char input = bluetooth.read();  // Read the incoming character
//        Serial.println(input);          // Print the input for debugging
//
//        switch (input) {
//            case 'F':  // Increase the desired tilt
//                last_command_time = millis();  // Update the last command time
//                desired_tilt += ANGLE_STEP;
//                Serial.print("New desired tilt angle: ");
//                Serial.println(desired_tilt);
//                break;
//
//            case 'B':  // Decrease the desired tilt
//                last_command_time = millis();  // Update the last command time
//                desired_tilt -= ANGLE_STEP;
//                Serial.print("New desired tilt angle: ");
//                Serial.println(desired_tilt);
...
//                break;
//
//            case 'Z':  // Turn on the buzzer
//                digitalWrite(12, HIGH);
//                Serial.println("Buzzer ON");
//                break;
//
//            case 'z':  // Turn off the buzzer
//                digitalWrite(12, LOW);
...
//                break;
//
//            case 'P':  // Reset desired tilt to initial tilt
//                desired_tilt = initial_tilt;
//                Serial.println("Desired tilt reset to initial tilt");
//                break;
//
...
//    }
//
//    // Reset the desired tilt to the initial tilt if the timeout has elapsed
